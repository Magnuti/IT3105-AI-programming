...
if __name__ == "__main__":
    ...
    rl_agent = RL_agent(sim_world, args.episodes, args.critic_type, args.learning_rate_critic, args.learning_rate_actor, args.eligibility_decay_critic,
                        args.eligibility_decay_actor, args.discount_factor_critic, args.discount_factor_actor, args.epsilon, args.visualize, args.visualize_training_episodes, args.frame_time)
    rl_agent.play()
